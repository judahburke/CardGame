...
using CardGame.Web.Angular.ViewModels;
using CardGame.Web.Angular.Helpers;
using CardGame.Web.Angular.Authorization;
...
namespace CardGame.Web.Angular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("CardGame.Web.Angular"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "CardGame.Web.Angular API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CardGame.Web.Angular API V1");
            });
